...
data class Matrix4f(
  ...
  companion object {
    ...
    fun orthogonal(top: Float, right: Float, bottom: Float, left: Float, near: Float, far: Float): Matrix4f {
    ...
    fun perspective(fov: Float, width: Int, height: Int, near: Float, far: Float): Matrix4f {
  ...
  operator fun times(c: Float): Matrix4f {
    return Matrix4f(
  ...
  fun multiply(m: Matrix4f): Matrix4f {
    return Matrix4f(
